      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto max-w-[1440px] px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28 xl:px-16">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            ...
            >
              Every stage is designed to improve water quality, simplify access
              and create a reliable refill experience. From purification to
              smart-card dispensing, the system brings technology and
        ...
        >
          ...
          <div className="relative z-10 flex min-h-[390px] items-center justify-center px-5 py-16 text-center text-white sm:px-8">
            ...
            >
              ...
              >
                Speak with our team about the right water station, purification
                system or institutional package for your requirements.
              </motion.p>
