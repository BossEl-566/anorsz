      ...
      >
        ...
        <div className="relative mx-auto max-w-[1440px] px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28 xl:px-16">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={viewport}
            className="mt-12 grid gap-px border border-black/10 bg-black/10 sm:grid-cols-2 lg:mt-16 lg:grid-cols-3"
          >
            {technologyFeatures.map((feature) => {
              ...
              return (
                <motion.article
                  ...
                  className="group min-h-[335px] bg-white p-7 transition duration-300 hover:z-10 hover:bg-[#681761] hover:text-white sm:p-8"
                >
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto max-w-[1440px] px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28 xl:px-16">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={viewport}
            className="mt-12 grid gap-px border border-black/10 bg-black/10 lg:mt-16 lg:grid-cols-5"
          >
          ...
          <motion.p
            ...
            whileInView="visible"
            viewport={viewport}
            className="mt-5 max-w-3xl text-xs leading-6 text-black/45"
          >
          ...
          >
            {stationConfigurations.map((configuration, index) => (
              <motion.article
                ...
                className="group min-h-[390px] bg-[#f8f7f5] p-7 transition duration-300 hover:z-10 hover:bg-[#681761] hover:text-white"
              >
                <div className="flex items-start justify-between">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#681761]/10 text-[#681761] transition group-hover:bg-white/15 group-hover:text-white">
      ...
      <section className="bg-[#f7f6f4]">
        <div className="mx-auto grid max-w-[1440px] gap-12 px-5 py-20 sm:px-8 sm:py-24 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-20 lg:px-12 lg:py-28 xl:px-16">
          <motion.div
            ...
            whileInView="visible"
            viewport={viewport}
            className="relative min-h-[520px] overflow-hidden bg-[#d9d2db]"
          >
            <Image
      ...
      <section className="border-y border-black/10 bg-[#f7f6f4]">
        <div className="mx-auto grid max-w-[1440px] gap-8 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:px-12 xl:px-16">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={viewport}
            className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-end"
          >
