...
const contactCards: ContactCard[] = [
  ...
  },
  {
    ...
    icon: MapPin,
    content: (
      <p className="mt-5 text-sm font-medium text-[#681761]">
        Ghana
      </p>
    ),
  },
  ...
  return (
    <main className="overflow-hidden bg-[#f7f6f4] text-[#171319]">
      ...
      <section className="relative isolate min-h-[72svh] overflow-hidden bg-[#160b19] text-white">
        ...
        {/* Top darkness for transparent header */}
          ...
          <div className="w-full">
            ...
            <div className="mt-6 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
              ...
              <p className="max-w-xl text-sm leading-7 text-white/72 sm:text-base lg:justify-self-end">
                Tell us about your institution, community or water project.
                Our team will help you identify a suitable water station,
          ...
          <div className="mt-12 grid border-l border-t border-black/10 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4">
            {contactCards.map((card) => {
              ...
              return (
                <article
                  key={card.title}
                  className="group min-h-[310px] border-b border-r border-black/10 bg-white p-7 transition duration-300 hover:z-10 hover:-translate-y-1 hover:border-[#681761]/30 hover:shadow-[0_24px_60px_rgba(50,14,49,0.1)]"
                >
      ...
      <section id="enquiry-form" className="scroll-mt-24 bg-white">
        <div className="mx-auto grid max-w-[1440px] gap-0 px-5 py-20 sm:px-8 sm:py-24 lg:grid-cols-[0.82fr_1.18fr] lg:px-12 lg:py-28 xl:px-16">
          ...
          <div className="relative min-h-[500px] overflow-hidden bg-[#221025] text-white lg:min-h-full">
            <Image
              src={aboutStoryImage}
            ...
            <div className="relative flex min-h-[500px] h-full flex-col justify-end p-7 sm:p-10 lg:p-12">
          ...
          {/* Form */}
          <div className="border border-black/10 bg-[#faf9f7] p-6 sm:p-9 lg:p-12">
            <div className="mb-9">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#681761] sm:text-xs">
                Send an Enquiry
              </p>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28 xl:px-16">
          ...
          <div className="mt-12 grid gap-5 lg:mt-16 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="relative min-h-[520px] overflow-hidden bg-[#ddd7df]">
              <Image
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
              <div className="relative min-h-[250px] overflow-hidden bg-[#ddd7df]">
                <Image
